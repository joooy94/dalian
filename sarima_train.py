...
# 配置参数
DATA_FILE_PATH = '/Users/wangzhuoyang/dalian/202505.csv'
DATE_COLUMN = 'date'
TARGET_COLUMN = 'OT'
SAMPLING_INTERVAL = 30  # 分钟
OUTPUT_DIR = 'sarima_results'
MODEL_FILE = 'sarima_model.pkl'

# SARIMA参数 (p,d,q)(P,D,Q,s)
SARIMA_ORDER = (1, 1, 1)
SEASONAL_ORDER = (1, 1, 1, 48)  # 季节性周期为一天(48个30分钟)
...
def main():
    ...
    # 保存训练集和测试集数据
    save_data_to_csv(train_data, 'train_data.csv', output_dir)
    save_data_to_csv(test_data, 'test_data.csv', output_dir)
